    ...
    suspend fun syncUsuarios() {
        ...
        for (usuarioRemoto in remotos) {
            ...
            if (local == null) {
                ...
                usuarioDao.update(
                    usuarioRemoto.toLocal().copy(localId = local.localId)
                )
            }
        }
    ...
    suspend fun syncCategorias() {
        ...
        for (categoriaRemota in remotas) {
            ...
            if (local == null) {
                ...
                categoriaDao.update(
                    categoriaRemota.toLocal().copy(localId = local.localId)
                )
            }
        }
    ...
    suspend fun syncGastos() {
        ...
        for (gastoRemoto in remotos) {
            ...
            if (local == null) {
                ...
                gastoDao.update(
                    gastoRemoto.toLocal().copy(localId = local.localId)
                )
            }
        }
    ...
    suspend fun syncPresupuestos() {
        ...
        for (presupuestoRemoto in remotos) {
            ...
            if (local == null) {
                ...
                presupuestoDao.update(
                    presupuestoRemoto.toLocal().copy(localId = local.localId)
                )
            }
        }
    ...
    suspend fun syncMetas() {
        ...
        for (metaRemota in remotos) {
            ...
            if (local == null) {
                ...
                metaAhorroDao.update(
                    metaRemota.toLocal().copy(localId = local.localId)
                )
            }
        }
